...
namespace VStore.ProductApi.Controllers
{
    ...
    {
        private readonly ICRUDService<CategoryResponse, CategoryInput> _service;
        private readonly ILogger<ProductsController> _logger;

        public CategoriesController(ICRUDService<CategoryResponse, CategoryInput> service, ILogger<ProductsController> logger)
        {
            _service = service;
            _logger = logger;
        }
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromQuery] int id, [FromBody] CategoryInput input)
        {
            try
            {
